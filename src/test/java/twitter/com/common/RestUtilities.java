...
public class RestUtilities {
    ...
    public static RequestSpecification createQueryParam(RequestSpecification requestSpec, String param, String value) {
        return requestSpec.queryParam(param, value);
    }

    public static RequestSpecification createPathParam(RequestSpecification requestSpec, Map<String, String> queryMap) {
        return requestSpec.queryParams(queryMap);
    }
    ...
    public static Response getResponse(RequestSpecification requestSpec, String type) {
        REQUEST_SPEC.spec(requestSpec);
